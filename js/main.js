...
/* harmony import */ var _components_circular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/circular */ "./src/js/components/circular.js");
/* harmony import */ var _components_circular__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_circular__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _functions_disable_scroll__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/disable-scroll */ "./src/js/functions/disable-scroll.js");
...
/* harmony import */ var _vendor_accordion_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_vendor_accordion_js__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _vendor_price_includes_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./vendor/price-includes.js */ "./src/js/vendor/price-includes.js");
/* harmony import */ var _vendor_price_includes_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_vendor_price_includes_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _vendor_yandex_map_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./vendor/yandex-map.js */ "./src/js/vendor/yandex-map.js");
/* harmony import */ var _vendor_yandex_map_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_vendor_yandex_map_js__WEBPACK_IMPORTED_MODULE_3__);
...
$$('.circular').forEach(function (el) {
  paintCircle(el, el.dataset.box, el.dataset.diametr);
});

function paintCircle(el, box, diametr) {
  var NS = "http://www.w3.org/2000/svg";
  var svg = document.createElementNS(NS, "svg");
  svg.setAttribute("viewBox", "0 0 ".concat(box, " ").concat(box));
  var circle = document.createElementNS(NS, "path");
  circle.setAttribute("d", "M0,".concat(diametr, " a").concat(diametr, ",").concat(diametr, " 0 1,1 0,1z"));
...
const galleryTop = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-top', {
  spaceBetween: 10,
  navigation: {
...
const galleryThumbs = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.gallery-thumbs', {
  spaceBetween: 35,
  centeredSlides: true,
  slidesPerView: 'auto',
  touchRatio: 0.2,
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.frontage-swiper', {
...
const layoutSwiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.layout-appart-swiper', {
  direction: 'horizontal',
  loop: true,
  spaceBetween: 50,
  centeredSlides: true,
...
(function () {
  ...
  burger === null || burger === void 0 ? void 0 : burger.addEventListener('click', e => {
    ...
    if (menu !== null && menu !== void 0 && menu.classList.contains('nav--active')) {
...
/***/ "./src/js/vendor/price-includes.js":
/*!*****************************************!*\
  !*** ./src/js/vendor/price-includes.js ***!
  \*****************************************/
/***/ (() => {

const IncludesItem = document.querySelectorAll('.price-includes__item');

const deafaultPositionItem = function () {
  IncludesItem.forEach(el => {
    let numbOrderElem = el.getAttribute('data-numb');
    el.style.order = numbOrderElem;
  });
};

IncludesItem.forEach((el, idx) => {
  el.setAttribute('data-index', idx);
  el.style.order = +idx;
  el.addEventListener('click', e => {
    deafaultPositionItem();
    const index = e.currentTarget.dataset.index;

    if (index == 0) {
      el.style.order = "2";
      IncludesItem[2].style.order = "0";
    }

    if (index == 1) {
      el.style.order = "3";
      IncludesItem[3].style.order = "1";
    }

    if (index == 2) {
      el.style.order = "5";
      IncludesItem[5].style.order = "2";
    }

    if (index == 4) {
      el.style.order = "6";
      IncludesItem[6].style.order = "4";
    }

    if (index == 6) {
      el.style.order = "5";
      IncludesItem[5].style.order = "6";
    }

    IncludesItem.forEach((el, idx) => {
      el.classList.remove('price-includes__item--active');
    });
    e.currentTarget.classList.add('price-includes__item--active');
  });
});

/***/ }),

/***/ "./src/js/vendor/yandex-map.js":
/*!*************************************!*\
  !*** ./src/js/vendor/yandex-map.js ***!
  \*************************************/
/***/ (() => {

let centerMark = [55.761219, 37.717735];
...
function init() {
  ...
  let placemark = new ymaps.Placemark(centerMark, {}, {
    iconLayout: 'default#image',
    iconImageHref: 'img/lacation_denver.png',
    iconImageSize: [106, 152],
